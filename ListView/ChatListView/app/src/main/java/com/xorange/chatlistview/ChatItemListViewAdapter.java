...
public class ChatItemListViewAdapter extends BaseAdapter {
    private List<ChatListViewItemBean> mData;
    private LayoutInflater mInflater;


    public ChatItemListViewAdapter(Context context, List<ChatListViewItemBean> data) {
        this.mData = data;
    ...
    public int getItemViewType(int position) {
        ChatListViewItemBean bean = mData.get(position);
        return bean.getType();
    }
